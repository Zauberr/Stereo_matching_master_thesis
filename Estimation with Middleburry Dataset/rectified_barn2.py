...
folderName = 'LocalResult' + '_rectified_Img_with_barn2'
...
'''
fieldNum = 2
field_0 = [50, 92, 283, 85]
field_1 = [200, 94, 226, 109]
fieldBottom = [field_0, field_1]

qThreshold = 1e-4
heThreshold = 0
# first target second template, from template to target from right to left; 6 right to 2 left
test = cali.calibrated_image('/Users/zauber/Desktop/Stereo_matching/Photo/barn2/im2.ppm',
                             '/Users/zauber/Desktop/Stereo_matching/Photo/barn2/im6.ppm',
                             folderName, qThreshold, heThreshold, 7)
...
ground_truth = cv2.imread('/Users/zauber/Desktop/Stereo_matching/Photo/barn2/disp6.pgm', cv2.IMREAD_GRAYSCALE)
