...
'''
fieldNum = 3
field_0 = [280, 169, 267, 140]
field_1 = [865, 197, 388, 198]
field_2 = [351, 172, 556, 92]
...
# right as target image, left as template image. H transform template to target(left to right)
...
H_inf = np.array([[9.935e-01, -3.861e-03, 2.90e+01],
                  [3.312e-03, 1.002e+00, -1.596e+01],
                  [-1.050e-05, 5.856e-06, 1.00e+00]], dtype=np.float32)
e = np.array([-8.40e+02, -2.804e+00, 8.890e-03], dtype=np.float32).reshape(3, 1)
...
a_0, b_0, c_0 = -4.828e-05, -2.407e-05, 1.171e-01
a_1, b_1, c_1 = 5.284e-05, -1.279e-05, 6.197e-02
a_2, b_2, c_2 = 4.911e-05, 1.852e-04, -1.408e-02
...
for j in range(fieldNum):
    ...
    difference, legend = test.show_difference_of_warp_image(warped_image, warped_image_gt, fieldBottom[j],
                                                            5, r_correctTemp[j])
