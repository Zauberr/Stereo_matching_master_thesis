...
'''
fieldNum = 3
field_0 = [78, 229, 343, 170]
field_1 = [794, 237, 181, 254]
field_2 = [445, 264, 477, 211]
...
H_inf = np.array([[9.52e-01, -1.61e-01, 2.06e+02],
                  [1.88e-01, 1.00e+00, -2.35e+02],
                  [-4.01e-05, 6.27e-05, 9.92e-01]], dtype=np.float32)
e = np.array([-1.21e+03, -4.60e+01, -7.75e-02], dtype=np.float32).reshape(3, 1)
...
a_0, b_0, c_0 = -3.18e-05, -3.30e-06, 1.00e-01
a_1, b_1, c_1 = 5.10e-05, -1.23e-05, 5.98e-02
a_2, b_2, c_2 = 1.06e-05, 4.19e-05, 7.33e-02
