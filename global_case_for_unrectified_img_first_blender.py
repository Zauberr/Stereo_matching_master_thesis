...
textName = folderName + '/Result' + '.txt'
...
print('Final Result:', file=text)
print('H_inf:', H_inf_temporary, file=text)
print('e:', e_temporary, file=text)
print('q:', qTemporary, file=text)
print('r_correct:', r_correctTemp, file=text)
text.close()
